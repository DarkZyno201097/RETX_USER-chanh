...
export default function TabTransactionSingleAsset(props: IProps) {
        ...
        },
        {
            ...
            render: (value) => (
                <span style={{ fontWeight: 400 }}>
                    <span style={{ color: value == 'swapTokensForExactTokens' ? "#3fdd3a" : value == 'transfer' ? '#212529' : '#e33737', width: 50, textAlign: 'left' }}>
                        {value == 'swapTokensForExactTokens' ? trans[locate].buy : value == 'transfer' ? 'P2P' : trans[locate].sell}
                    </span>
                </span>
            )
        },
